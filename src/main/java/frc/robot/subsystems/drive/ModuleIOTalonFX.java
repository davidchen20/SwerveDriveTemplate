  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(-2.58 + 1.83); // MUST BE CALIBRATED
        break;
      case 1:
        ...
        absoluteEncoderOffset = new Rotation2d(-1.98); // MUST BE CALIBRATED
        break;
      case 2:
        ...
        absoluteEncoderOffset = new Rotation2d(-1.93); // MUST BE CALIBRATED
        break;
      case 3:
        ...
        absoluteEncoderOffset = new Rotation2d(2.54); // MUST BE CALIBRATED
        break;
      default:
